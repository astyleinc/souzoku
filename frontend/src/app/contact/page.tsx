          ...
          <div className="lg:col-span-3 bg-white rounded-2xl shadow-card p-6">
            <div className="space-y-5">
              <div>
                ...
                <select className="w-full px-4 py-2.5 text-sm border border-neutral-200 rounded-xl bg-neutral-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-500/20">
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5">お問い合わせ内容</label>
                <textarea
                  rows={5}
              ...
              <div className="flex items-start gap-2">
                <input type="checkbox" id="privacy-agree" className="mt-1 rounded border-neutral-300" />
