    ...
    <>
      ...
      <div className="px-4 py-4 mx-3 mb-3 bg-neutral-50 rounded-xl">
        <div className="flex items-center gap-3">
          ...
          <button className="p-1.5 text-neutral-400 hover:text-neutral-600 hover:bg-neutral-200 rounded-lg transition-colors shrink-0">
